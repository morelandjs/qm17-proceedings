...
%The ranges of the sampled model parameters are shown in Tbl.~\ref{ranges}.
%
...
%    $\log_2(N_\mathrm{partons}$) & Parton number (log space) & 0--4.5 \\
%    $w$    & Nucleon width & 0.4--1 fm \\
%    $\chi$ & Nucleon structure & 0--1
%  \end{tabular}
%  \caption{
%    \label{ranges} Input parameter ranges for the initial condition model.
%  }
%\end{wraptable}
